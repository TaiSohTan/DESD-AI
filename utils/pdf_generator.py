...
def generate_prediction_pdf(prediction):
    ...
    c.setFillColor(text_color)
    c.setFont('Helvetica', 9)
    c.drawCentredString(width/2, footer_y, "This report was generated by MLAAS - Machine Learning as a Service")
    c.drawCentredString(width/2, footer_y - 15, "For questions about this prediction, please contact support@mlaas.com")
